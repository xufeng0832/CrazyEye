    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_addr', models.GenericIPAddressField()),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('password', models.CharField(help_text='如果auth_type选择为ssh-key,那么此处就应该是key', max_length=256)),
            ],
        ),
        migrations.CreateModel(
            name='UserProfile',
        ...
        migrations.AlterUniqueTogether(
            name='host',
            unique_together=set([('id_addr', 'port')]),
        ),
        migrations.AlterUniqueTogether(
            name='bindhost',
